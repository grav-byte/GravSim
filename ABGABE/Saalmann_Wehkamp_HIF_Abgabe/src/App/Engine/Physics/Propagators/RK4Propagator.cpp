...
void RK4Propagator::Propagate(SceneObject& object, const PhysicsContext& context, const float deltaTime) {
        // k1
        glm::vec2 k1_v = context.GetAcceleration(object);
        ...
        glm::vec2 k2_v = context.GetAcceleration(object);
        ...
        glm::vec2 k3_v = context.GetAcceleration(object);
        ...
        glm::vec2 k4_v = context.GetAcceleration(object);
