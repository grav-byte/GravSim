...
void ArrowRenderer::RenderArrow(const glm::vec2 origin, const glm::vec2 direction, const glm::vec4 color, const int width=5) const {
        const glm::vec2 tip = origin + direction;

        const float arrowHeadLength = 1.0f;
